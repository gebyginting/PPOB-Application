...
class ViewModelFactory(
    ...
    private val userRepository: UserRepository, private val userPreference: UserPreference
    ...
    companion object {
        ...
        fun getInstance(context: Context): ViewModelFactory =
            instance ?: synchronized(this) {
                ...
                instance ?: ViewModelFactory(Injection.provideAuthRepository(context), Injection.provideUserRepository(context), userPref)
            }.also { instance = it }
    }
}